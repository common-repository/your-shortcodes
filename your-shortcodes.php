<?php
/**
 * Plugin Name: Your Shortcodes List
 * Plugin URI: http://www.sujinc.com/
 * Description: Find all shortcodes which you can use on your website.
 * Version: 1.5.0
...
# 부릉부릉
include_once( YOURSC_CLASS_DIR . '/wp-hack/class.admin_page.php');
include_once( YOURSC_CLASS_DIR . '/wp-hack/class.helper.php');
